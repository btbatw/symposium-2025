...
export const ttbaSymposium2017 = {
	...
	'about': {
		...
		'subjects': [{
			'title': '',
			'description': `
			<p>2025 BTBA 13th Annual Symposium will take place on <b>July 12-13, at Harvard University Northwest Building, in Cambridge, MA. </b> <a href="https://www.btbatw.org/symposium.html" target="_blank" rel="noopener noreferrer">Learn more about our past annual symposia.</a></p>
            `
		}, {
			'title': 'Registration',
	...
	'programme': {
		...
		'schedules': [{
			...
			'title': 'Keynote Speech I: Michael McKenna, CMO and Co-Founder of Akouos (A subsidiary of Eli Lilly and Company)',
			'topic': "TBD",
